...
.background-image {
    ...
    <div class="content">
       <section id="about" class="about section-padding">
        ...
        <div class="container">
        <center><p style="align-item:center; margin-top:200px;color:#12294D ; font-size:40px; font-weight:bold;"><br>About Us</p></center>
            <div class="row" id="con" style=" margin-top:80px;">
                <div class="col-lg-4 col-md-12 col-12">
                    ...
                    <div class="assets/about-img">
                    <img src="assets/images/courses_3.jpg" alt="" class="img-fluid" id="im" style="margin-top:-70px;"></div>
                </div>
                <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
                    <div class="about-text">
                          <h2 style="font-weight: bold; ">Experience. Educate. Evolve<br/> </h2><br><br>
