             ...
             <option value="EEAC">EEAC/</option>
              <option value="FRAMO">FRAMO/</option>
               <option value="BWTS-NK">BWTS-NK/</option>
                ...
                <div class="form-group">
                    <label for="passportNumber">Seamen Book/Passport Number:</label>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   // $checkExistingQuery = "SELECT * FROM verification WHERE certificateNo = '$certificateNo'";
    $checkExistingQuery = "SELECT * FROM verification1 WHERE certificateStripes = '$certificateStripes' AND certificateCourse = '$certificateCourse/' AND certificateNo = '$certificateNo'";
